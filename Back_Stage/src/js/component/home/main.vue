...
.user_btn{width: 100%;font-size: 0;text-align: center;}
.user_btn a{display: inline-block;vertical-align: middle;font-size: 12px;color: #fff;padding: 10px 25px;margin: 0 8px;cursor: pointer;border-radius: 6px;transition: all ease 0.2s;-webkit-transition: all ease 0.2s;}
.user_btn a:first-child{background: rgba(1,215,178,1);}
.user_btn a:first-child:hover{background: rgba(1,215,178,0.7);}
.user_btn a:last-child{background: rgba(8,161,239,1);}
.user_btn a:last-child:hover{background: rgba(8,161,239,0.7);}
</style>
