			...
			save: function save() {
				...
				$.ajax({
					...
					data: {
						...
						mainCode: (0, _stringify2.default)(_this.workData.mainCode)
					},
					success: function success(data) {
						actions.alert(store, {
							show: true,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AttrList = __webpack_require__(88);
	var MaterialLib = __webpack_require__(93);
