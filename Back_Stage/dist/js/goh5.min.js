...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "\n.set_page{position: fixed;left: 0;top: 60px;width: 100%;height: 100%;background-color: rgba(0,0,0,0.6);padding-bottom: 60px;z-index: 99999;}\n.set_bg{position: absolute;width: 100%;height: 100%;top: 0;left: 0;}\n.set_con{position: absolute;right: 0;background-color: #fff;width: 700px;height: 100%;top: 0;display: -webkit-box;display: -webkit-flex;display: -ms-flexbox;display: flex;-webkit-box-orient: horizontal;-webkit-box-direction: normal;-webkit-flex-direction: row;-ms-flex-direction: row;flex-direction: row;}\n.set_con .left{width: 300px;}\n.set_con .right{-webkit-box-flex: 1;-webkit-flex: 1;-ms-flex: 1;flex: 1;}\n", ""]);
