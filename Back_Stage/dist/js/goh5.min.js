...
/***/ function(module, exports, __webpack_require__) {
	...
	var Pagination = __webpack_require__(28);
	...
	var List = Vue.extend({
		data: function data() {
			return {
				...
				paginationConf: {
					...
					setTotalItems: function setTotalItems(cb) {
						this.totalItems = 50;
					}
				}
			};
		...
		methods: {
			...
			loadList: function loadList(type, cb) {
				$.ajax({
					url: '/api/list',
					type: 'get',
					success: function success(data) {
